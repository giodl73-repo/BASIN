...
VTRACE adoption scope: connect BASIN's accepted requirements to mission needs,
CONOPS scenarios, controlled specification items, future design surfaces, work
packages, verification, validation, and evidence. BASIN is greenfield: design
...
| REQ-004 | NEED-004 / CON-002 / OPS-001 | SPEC-001 | water kernel (`basin-network`) | deferred → IMPL_PLAN | VER-004 / schema check | OPS-001 | future EVID-004 | accepted |
...
| REQ-007 | NEED-002 / CON-001 / OPS-003 / OPS-006 | SPEC-005 / SPEC-HB-01 | scoring + tier (hydrologic basis) | deferred → IMPL_PLAN | VER-007 / analysis / inspection | OPS-003 | future EVID-007 | accepted |
...
| DEF-002 | Explicit multi-year drought-sequence modelling. | `SPECIFICATION_BASELINE` (SPEC-HB-02) | deferred |
...
| SPEC-UNK-001 | Cross-scale data openness for DIM-01/05/09. | data steward | discovery |
| SPEC-UNK-002 | Firm-yield records for DIM-02. | drought hydrologist | accept risk (proxy) |
| SPEC-UNK-003 | Benefit-cost basis for DIM-12. | water economist | defer to calibration |
| SPEC-UNK-004 | Per-tier SLA thresholds (DIM-13). | BASIN maintainer | defer to calibration |
| SPEC-UNK-005 | Scale nesting representation. | BASIN maintainer | defer (DEF-005) |
...
- Dimension weights, SLA thresholds, and scale nesting are provisional; the trace
  does not claim calibrated values.
...
| Drought Hydrologist | REQ-007/REQ-015 trace the hydrologic basis and tier-SLA gating through SPEC-005/SPEC-012. | pass |
| Basin Planner | NEED-007/008 trace cleanly to REQ-014/015/016 and SPEC-011/012/013. | pass |
