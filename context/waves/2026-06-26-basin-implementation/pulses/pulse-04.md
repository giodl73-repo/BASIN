# Pulse 04: WP-004 `basin-tier` tier classification + SLA conformance
...
(naming the hydrologic basis, REQ-007), and emit tier-SLA gaps. Creates
`crates/basin-tier/` and a `tiers.toml` SLA record (IF-004), values provisional.

Parent: REQ-014/015 · SPEC-011/012 · DIM-13 · IF-004 · PKG-004 · CR-004/007.

Exit: `cargo test -p basin-tier` green (classification, conforming element,
