...
BASIN scores water-system elements, classifies service tiers, and finds
evidence-backed gaps in supply, demand, storage, conveyance, drought resilience,
reuse, leakage, and access.
...
milestone is the first cited end-to-end water-system analysis.
